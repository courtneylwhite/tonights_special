        ...
        <div className="w-full min-h-screen flex flex-col justify-center items-center bg-black p-8 gap-8">
            ...
            <div ref={clocheRef} className="w-32 h-32">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 227.5 227.5">
                    <path className="fill-white" d="M33.05,96.93s3.39-73.12,80.7-76.2c52.37,2.24,77.03,39.5,79.27,76.2-7.56.28-7.56,0-7.56,0,0,0-4.76-55.19-57.71-65.84,11.21,5.6,46.79,16.5,49.31,65.96-10.93-.12-144-.12-144-.12Z"/>
                    <path className="fill-white" d="M4.19,100.29h217.12s4.2-.28,4.2,1.96-2.52,2.8-4.76,2.8-17.37.56-20.17,1.4-3.36,3.92-11.77,3.92H53.78c-8.83,0-18.49,1.68-22.97-1.68-3.92-3.16-11.21-3.16-25.49-3.16-3.08.08-3.04-3.04-3.04-3.04,0,0-.6-2.2,1.92-2.2Z"/>
                    <path className="fill-white" d="M58.35,163.16l13.3,26.24,37.39-24.98s10.78-8.09,16-13.48c5.03-4.85,13.3-13.48,16.36-16.36s9.89-9.17,12.94-10.42,8.27-2.88,9.89-4.31,1.44-5.35-1.8-6.09-6.83-.38-9.53.88-5.57,1.26-17.79,10.24c-6.29,3.95-14.74,8.63-22.29,11.68-5.39,1.8-10.6,4.31-15.46,4.13s-8.63-2.34-13.66-12.94-9.17-15.28-14.74-14.38-5.39,2.7-5.21,3.6,4.85,5.75,5.93,8.09,2.52,7.01,1.62,13.84.36,10.32-.9,12.44-1.98,5-4.13,6.62-7.91,5.21-7.91,5.21Z"/>
                    <path className="fill-white" d="M54.76,164.41l-24.98,11.5,19.05,36.67,23.9-14.2-17.97-33.97ZM60.01,198.09c-1.15-.32-1.82-1.51-1.5-2.66.32-1.15,1.51-1.82,2.66-1.5,1.15.32,1.82,1.51,1.5,2.66-.32,1.15-1.51,1.82-2.66,1.5Z"/>
                    <path className="fill-white" d="M107.96,19.19h10.78s-1.08-3.95,4.13-8.09c.36-1.44-3.11-6.29-9.01-6.11s-9.86,3.95-9.68,5.39,4.6,4.9,3.77,8.81Z"/>
                </svg>
            </div>
            ...
            {/* Welcome Link */}
            <div ref={welcomeLinkRef} className="mt-8 opacity-0">
                <Link to={currentUser ? "/pantry" : "/signin"} className="text-white hover:text-gray-300 text-lg font-medium flex items-center transition-colors duration-300">
